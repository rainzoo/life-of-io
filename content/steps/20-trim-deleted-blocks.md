...
keyConcept: TRIM
simple: `blkdev_issue_discard()` sends DEALLOCATE for freed LBAs; the FTL erases blocks lazily.
---
...
`blkdev_issue_discard()` → NVMe Dataset Management with DEALLOCATE attribute.
